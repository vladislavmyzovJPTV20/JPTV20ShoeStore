...
public class TakeProductComponent extends JPanel{
    ...
    private void initComponents() {
        ...
        captionComponent = new CaptionComponent("Выберите обувь для покупки", GuiApp.WIDTH_WINDOW, 30);
        ...
        this.add(Box.createRigidArea(new Dimension(0,5)));        
        buttonComponent = new ButtonComponent("Купить обувь", GuiApp.WIDTH_WINDOW, 20, 200, 200);
