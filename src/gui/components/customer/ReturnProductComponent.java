...
public class ReturnProductComponent extends JPanel{
    ...
    private void initComponents() {
        ...
        captionComponent = new CaptionComponent("Возврат обуви в магазин", GuiApp.WIDTH_WINDOW, 30);
        ...
        buttonComponent = new ButtonComponent("Вернуть обувь",GuiApp.WIDTH_WINDOW, 30, 200,150);
        ...
        buttonComponent.getButton().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(historyReturnBooks.isEmpty()){
                    ...
                    infoComponent.getInfo().setText("Выберите название обуви");
                    return;
                }
